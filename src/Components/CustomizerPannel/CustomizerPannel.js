      ...
      <div className="customizer-pannel">
        <form id="customizer-form">
          <div className="form-section">
            <label htmlFor="width">
              Number of Pattern Repititions Horizontally
            </label>
            <input
              type="number"
              min="1"
            ...
            />
            {this.state.width.touched && (
              <ValidationError message={widthError} />
            )}
          </div>
          <div className="form-section">
            <label htmlFor="height">
              Number of Pattern Repititions Vertically
            </label>
            <input
              type="number"
              min="1"
          ...
          <div className="form-section">
            ...
            {this.state.border.touched && (
              <ValidationError message={borderError} />
            )}
          </div>
        </form>
      </div>
